...
public class Simulation3D : MonoBehaviour
{
    ...
    //nuevo
    public ComputeBuffer meshPositionBuffer { get; private set; }
    ...
    void Start()
    {
        ...
        meshPositionBuffer = ComputeHelper.CreateStructuredBuffer<float3>(numMeshVertices);
        meshNormalBuffer = ComputeHelper.CreateStructuredBuffer<float3>(numMeshVertices);
